CREATE OR ALTER PROCEDURE silver.load_silver AS
    BEGIN
        ...
        BEGIN TRY
                ...
                PRINT '>>> Transferring data to silver.crm_cust_info';
                ...
                *, ROW_NUMBER() over (partition by cst_id order by cst_create_Date DESC) as flag_last 
                ...
                PRINT '>>> Transferring data to silver.crm_prd_info';
                ...
                PRINT '>>> Transferring data to silver.crm_sales_details';
                ...
                PRINT '>>> Transferring data to silver.erp_cust_az12';
                ...
                PRINT '>>> Transferring data to silver.erp_loc_a101';
                ...
                PRINT '>>> Transferring data to silver.erp_px_cat_g1v2';
                ...
                PRINT '==============================================';
                PRINT 'Total time taken to load all Silver layer tables: ' + CAST(DATEDIFF(SECOND, @start_time_whole, @end_time_whole) AS VARCHAR) + ' seconds';
                PRINT '==============================================';
